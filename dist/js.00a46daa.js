...
var saveState = function saveState(mdl) {
  return localStorage.setItem("todos-mithril", JSON.stringify(mdl));
};
  ...
  view: function view(_ref) {
    ...
    return (0, _mithril.default)("header.header", [(0, _mithril.default)("h1", "todos"), (0, _mithril.default)("input.new-todo[placeholder='What needs to be done?'][autofocus]", {
      ...
      oninput: function oninput(e) {
        return mdl.new.title = e.target.value;
      },
      value: mdl.new.title
    })]);
  }
...
},{"mithril":"node_modules/mithril/index.js","./model":"js/model.js"}],"js/body.js":[function(require,module,exports) {
"use strict";
    ...
    return (0, _mithril.default)("section.main", [(0, _mithril.default)("input.toggle-all[id='toggle-all'][type='checkbox']", {
      ...
      return (0, _mithril.default)("li.".concat(todo.status, ".").concat(todo.isEditing && "editing"), {
        ...
        onclick: function onclick() {
          todo.status == "active" ? todo.status = "completed" : todo.status = "active", (0, _model.saveState)(mdl);
        }
      }), (0, _mithril.default)("label", {
        ondblclick: function ondblclick(_) {
          todo.isEditing = true;
          todo.newtitle = todo.title;
        }
      }, "".concat(todo.title)), (0, _mithril.default)("button.destroy", {
        onclick: function onclick() {
        ...
        oninput: function oninput(e) {
          return todo.newtitle = e.target.value;
        },
        value: todo.newtitle
      })]);
    }))]);
...
var _default = Body;
exports.default = _default;
},{"mithril":"node_modules/mithril/index.js","./model":"js/model.js"}],"js/footer.js":[function(require,module,exports) {
"use strict";
...
var totalActiveTodos = function totalActiveTodos(mdl) {
  return mdl.todos.filter(function (todo) {
    return todo.status == "active";
  }).length;
};

var todosCompleted = function todosCompleted(mdl) {
  return mdl.todos.filter(function (todo) {
    return todo.status == "completed";
  }).length;
};
